...
/** The MainActivity class extends AppCompatActivity and implements the NotesAdapter's ViewHolder's ClickListener */
public class MainActivity extends AppCompatActivity implements NotesAdapter.ViewHolder.ClickListener {
    ...
    * @param position The position of the item to be toggled */
   ...
   private class ActionModeCallback implements ActionMode.Callback {
      ...
      public boolean onCreateActionMode(ActionMode mode, Menu menu) {
         /* the method below assigns an inflater to inflate the menu containing
       ...
       * @param mode The ActionMode present
       * @param item The MenuItem that is clicked in actionMode
       * */
      @Override
       ...
       * @param adapter The ViewAdapter of the RecyclerView
       * @param notesViewModel The NotesViewModel that is called to perform db operation */
